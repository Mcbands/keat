...
class Ebook(View):
    def get(self, request):
        ...
        return render(request, "ebook.html",context={"page_obj": page_obj})
...
class School(View):
    def get(self, request):
        ...
        paginator = Paginator(courses, 8)  # Show 8 blogs per page
        page_number = request.GET.get('page')
        page_obj = paginator.get_page(page_number)
        return render(request, "school.html", context={"page_obj": page_obj,"blogs": blogs,})
